...
const CONFIG = {
  ...
  //   V9.8: 浮遊ドローンで横幅が大きく視野が狭い報告 → 4.1 → 3.7(約 10% = 一回り縮小)。
  //   V9.9: もう少し小さく要望 → 3.7 → 3.4(計 約 17% 縮小)。
  //   本体・ドローン配置/サイズ・接地高・照準・衝突半径が mechSizeK 経由で一括追従。
  CUSTOM_TARGET_HEIGHT: 3.4,
  ...
  WEAPONS: {
    ...
    // ============================================================
    // v8 追加武器（+26 / price 2000〜10000）。連射(rapid)・電撃(electric)・火炎(fire) を各帯に。
    //   family: rapid|electric|fire（ショップ種別タブ用）/ fxTier: 価格連動のエフェクト強度(P2)
    //   火炎系: flame=放射 / bolt+burn=火矢 / bolt+blast+burn=火球。電撃系: bolt+chain or tempest。
    // ============================================================
    // ---- 2000–3000 (+5) ----
    storm_rep: {
      name: 'STORM REPEATER', label: 'SREP', kind: 'bolt', size: 'medium', mount: 'arm', price: 2200,
      archetype: 'rapid', family: 'rapid', fxTier: 2,
      dmgMin: 5, dmgMax: 7, interval: 0.16, heat: 7, range: 52, boltSpeed: 52, boltScale: 0.6,
      color: 0x9fe8ff, colorE: 0xffc080, sfx: 'repeater', recoil: 0.012, spreadAim: 0.7, tag: '中・高速連射',
    },
    volt_lash: {
      name: 'VOLT LASH', label: 'VLSH', kind: 'bolt', size: 'medium', mount: 'arm', price: 2400,
      archetype: 'special', family: 'electric', fxTier: 2,
      dmgMin: 12, dmgMax: 16, interval: 1.2, heat: 22, range: 60, boltSpeed: 42, chain: 0.45, chainRange: 13,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.04, spreadAim: 0.25, tag: '中・電撃連鎖',
    },
    pyro_stream: {
      name: 'PYRO STREAM', label: 'PYRO', kind: 'flame', size: 'light', mount: 'arm', price: 2600,
      archetype: 'special', family: 'fire', fxTier: 2,
      dmgTick: 4, interval: 0.08, heat: 5, range: 18, coneDeg: 24, burn: { time: 2.5, dps: 8 },
      color: 0xff8030, colorE: 0xff5020, sfx: 'blazer', tag: '軽・火炎放射',
    },
    riot_gat: {
      name: 'RIOT GATLING', label: 'RIOT', kind: 'hitscan', size: 'heavy', mount: 'arm', price: 2800,
      archetype: 'rapid', family: 'rapid', fxTier: 2,
      dmgMin: 5, dmgMax: 7, interval: 0.10, heat: 6, range: 40, spinup: 0.6,
      color: 0xffd890, colorE: 0xff9860, sfx: 'havoc', recoil: 0.008, spreadAim: 1.1, tag: '重・回転連射',
    },
    shock_coil: {
      name: 'SHOCK COIL', label: 'SHCK', kind: 'tempest', size: 'light', mount: 'arm', price: 2900,
      archetype: 'special', family: 'electric', fxTier: 2,
      dmgTick: 7, tickInterval: 0.25, burnTime: 2, interval: 5, range: 38, chargeTime: 1.0, slowMul: 0.8,
      color: 0x9fd0ff, colorE: 0xcf9fff, sfx: 'tempest', recoil: 0.02, spreadAim: 0.1, tag: '軽・電撃照射',
    },
    // ---- 3000–4000 (+3) ----
    hornet_rep: {
      name: 'HORNET REPEATER', label: 'HRNT', kind: 'bolt', size: 'light', mount: 'arm', price: 3200,
      archetype: 'rapid', family: 'rapid', fxTier: 2,
      dmgMin: 6, dmgMax: 8, interval: 0.14, heat: 7, range: 55, boltSpeed: 54, boltScale: 0.55,
      color: 0xa8e8a0, colorE: 0xffc890, sfx: 'repeater', recoil: 0.012, spreadAim: 0.7, tag: '軽・高速連射',
    },
    thunder_arc: {
      name: 'THUNDER ARC', label: 'THND', kind: 'bolt', size: 'medium', mount: 'arm', price: 3500,
      archetype: 'special', family: 'electric', fxTier: 2,
      dmgMin: 16, dmgMax: 22, interval: 1.3, heat: 26, range: 64, boltSpeed: 44, chain: 0.5, chainRange: 14,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.05, spreadAim: 0.25, tag: '中・強電撃連鎖',
    },
    flame_lance: {
      name: 'FLAME LANCE', label: 'FLNC', kind: 'bolt', size: 'medium', mount: 'arm', price: 3800,
      archetype: 'range', family: 'fire', fxTier: 2,
      dmgMin: 14, dmgMax: 18, interval: 0.9, heat: 14, range: 80, boltSpeed: 62, boltScale: 0.7, boltTrail: 0.02,
      burn: { time: 2.5, dps: 9 },
      color: 0xff9040, colorE: 0xff6030, sfx: 'lance', recoil: 0.05, spreadAim: 0.08, tag: '中・火矢(延焼)',
    },
    // ---- 4000–5000 (+3) ----
    vulcan: {
      name: 'VULCAN ROTARY', label: 'VLCN', kind: 'hitscan', size: 'heavy', mount: 'arm', price: 4200,
      archetype: 'rapid', family: 'rapid', fxTier: 3,
      dmgMin: 7, dmgMax: 9, interval: 0.09, heat: 6, range: 42, spinup: 0.7,
      color: 0xffd890, colorE: 0xff9860, sfx: 'havoc', recoil: 0.008, spreadAim: 1.0, tag: '重・高速回転連射',
    },
    tesla_storm: {
      name: 'TESLA STORM', label: 'TSLA', kind: 'tempest', size: 'medium', mount: 'arm', price: 4500,
      archetype: 'special', family: 'electric', fxTier: 3,
      dmgTick: 12, tickInterval: 0.25, burnTime: 2.5, interval: 6, range: 42, chargeTime: 1.2, slowMul: 0.75,
      color: 0x9fd0ff, colorE: 0xcf9fff, sfx: 'tempest', recoil: 0.02, spreadAim: 0.1, tag: '中・電撃照射',
    },
    inferno_jet: {
      name: 'INFERNO JET', label: 'IJET', kind: 'flame', size: 'heavy', mount: 'arm', price: 4800,
      archetype: 'special', family: 'fire', fxTier: 3,
      dmgTick: 7, interval: 0.08, heat: 6, range: 22, coneDeg: 26, burn: { time: 3, dps: 12 },
      color: 0xff8030, colorE: 0xff5020, sfx: 'blazer', tag: '重・強火炎放射',
    },
    // ---- 5000–6000 (+3) ----
    plasma_rep: {
      name: 'PLASMA REPEATER', label: 'PREP', kind: 'bolt', size: 'medium', mount: 'arm', price: 5200,
      archetype: 'rapid', family: 'rapid', fxTier: 3,
      dmgMin: 9, dmgMax: 12, interval: 0.15, heat: 9, range: 58, boltSpeed: 56, boltScale: 0.7,
      color: 0x9fe8ff, colorE: 0xffc080, sfx: 'repeater', recoil: 0.015, spreadAim: 0.6, tag: '中・プラズマ連射',
    },
    lightning_net: {
      name: 'LIGHTNING NET', label: 'LNET', kind: 'bolt', size: 'heavy', mount: 'arm', price: 5500,
      archetype: 'special', family: 'electric', fxTier: 3,
      dmgMin: 20, dmgMax: 26, interval: 1.4, heat: 30, range: 60, boltSpeed: 40, chain: 0.6, chainRange: 16,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.06, spreadAim: 0.25, tag: '重・多段連鎖',
    },
    dragon_breath: {
      name: 'DRAGON BREATH', label: 'DRGN', kind: 'flame', size: 'heavy', mount: 'arm', price: 5800,
      archetype: 'power', family: 'fire', fxTier: 3,
      dmgTick: 9, interval: 0.08, heat: 7, range: 24, coneDeg: 30, burn: { time: 3, dps: 14 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'blazer', tag: '重・広角火炎',
    },
    // ---- 6000–7000 (+3) ----
    hailstorm: {
    ...
    arc_cascade: {
      name: 'ARC CASCADE', label: 'ACSD', kind: 'bolt', size: 'medium', mount: 'arm', price: 6500,
      archetype: 'special', family: 'electric', fxTier: 3,
      dmgMin: 22, dmgMax: 30, interval: 1.3, heat: 30, range: 66, boltSpeed: 46, chain: 0.65, chainRange: 16,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.06, spreadAim: 0.22, tag: '中・連鎖カスケード',
    },
    magma_spray: {
      name: 'MAGMA SPRAYER', label: 'MGMA', kind: 'bolt', size: 'heavy', mount: 'shoulder', price: 6800,
      archetype: 'power', family: 'fire', fxTier: 3,
      dmgMin: 30, dmgMax: 40, interval: 1.6, heat: 26, range: 50, boltSpeed: 40, boltScale: 1.4, blast: 4,
      burn: { time: 3, dps: 14 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'brute', recoil: 0.1, spreadAim: 0.2, tag: '重・火球(爆発+延焼)',
    },
    // ---- 7000–8000 (+3) ----
    tempest_rep: {
      name: 'TEMPEST REPEATER', label: 'TREP', kind: 'bolt', size: 'heavy', mount: 'arm', price: 7200,
      archetype: 'rapid', family: 'rapid', fxTier: 4,
      dmgMin: 12, dmgMax: 15, interval: 0.12, heat: 10, range: 60, boltSpeed: 60, boltScale: 0.75,
      color: 0x9fe8ff, colorE: 0xffc080, sfx: 'repeater', recoil: 0.015, spreadAim: 0.55, tag: '重・超連射',
    },
    volt_nova: {
      name: 'VOLT NOVA', label: 'VNVA', kind: 'tempest', size: 'medium', mount: 'arm', price: 7500,
      archetype: 'special', family: 'electric', fxTier: 4,
      dmgTick: 18, tickInterval: 0.25, burnTime: 3, interval: 7, range: 45, chargeTime: 1.2, slowMul: 0.7,
      color: 0x9fd0ff, colorE: 0xcf9fff, sfx: 'tempest', recoil: 0.02, spreadAim: 0.1, tag: '中・強電撃照射',
    },
    hellfire: {
      name: 'HELLFIRE STREAM', label: 'HELL', kind: 'flame', size: 'heavy', mount: 'arm', price: 7800,
      archetype: 'power', family: 'fire', fxTier: 4,
      dmgTick: 11, interval: 0.08, heat: 7, range: 26, coneDeg: 30, burn: { time: 3.5, dps: 18 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'blazer', tag: '重・地獄火炎',
    },
    // ---- 8000–9000 (+3) ----
    railstorm: {
      name: 'RAILSTORM', label: 'RSTM', kind: 'bolt', size: 'heavy', mount: 'arm', price: 8200,
      archetype: 'rapid', family: 'rapid', fxTier: 4,
      dmgMin: 14, dmgMax: 18, interval: 0.13, heat: 11, range: 70, boltSpeed: 64, boltScale: 0.8, boltTrail: 0.015, tracer: true,
      color: 0x9fe8ff, colorE: 0xffc080, sfx: 'lance', recoil: 0.02, spreadAim: 0.4, tag: '重・高速連射レール',
    },
    storm_bringer: {
      name: 'STORM BRINGER', label: 'SBRG', kind: 'bolt', size: 'heavy', mount: 'arm', price: 8500,
      archetype: 'special', family: 'electric', fxTier: 4,
      dmgMin: 28, dmgMax: 38, interval: 1.4, heat: 34, range: 64, boltSpeed: 46, chain: 0.7, chainRange: 18,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.07, spreadAim: 0.22, tag: '重・嵐の連鎖',
    },
    solar_flare: {
      name: 'SOLAR FLARE', label: 'SOLR', kind: 'bolt', size: 'heavy', mount: 'shoulder', price: 8800,
      archetype: 'power', family: 'fire', fxTier: 4,
      dmgMin: 40, dmgMax: 52, interval: 1.7, heat: 30, range: 55, boltSpeed: 42, boltScale: 1.6, blast: 4, tracer: true,
      burn: { time: 3.5, dps: 18 },
      color: 0xffa030, colorE: 0xff6020, sfx: 'annihilator', recoil: 0.12, spreadAim: 0.18, tag: '重・高温火球',
    },
    // ---- 9000–10000 (+3) ----
    omega_rep: {
      name: 'OMEGA REPEATER', label: 'OMGA', kind: 'bolt', size: 'heavy', mount: 'arm', price: 9200,
      archetype: 'rapid', family: 'rapid', fxTier: 4,
      dmgMin: 16, dmgMax: 20, interval: 0.12, heat: 12, range: 65, boltSpeed: 64, boltScale: 0.8,
      color: 0x9fe8ff, colorE: 0xffc080, sfx: 'repeater', recoil: 0.018, spreadAim: 0.5, tag: '重・最上位連射',
    },
    zeus_lance: {
      name: 'ZEUS LANCE', label: 'ZEUS', kind: 'tempest', size: 'heavy', mount: 'arm', price: 9500,
      archetype: 'special', family: 'electric', fxTier: 4,
      dmgTick: 24, tickInterval: 0.25, burnTime: 3, interval: 7, range: 48, chargeTime: 1.3, slowMul: 0.7,
      color: 0x9fd0ff, colorE: 0xcf9fff, sfx: 'tempest', recoil: 0.03, spreadAim: 0.1, tag: '重・神雷照射',
    },
    phoenix: {
      name: 'PHOENIX INFERNO', label: 'PHNX', kind: 'flame', size: 'heavy', mount: 'arm', price: 9800,
      archetype: 'power', family: 'fire', fxTier: 4,
      dmgTick: 14, interval: 0.08, heat: 8, range: 28, coneDeg: 32, burn: { time: 4, dps: 22 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'blazer', tag: '重・不死鳥火炎',
    },

    // ---- v8 P2 追加: カテゴリ×サイズで各3種以上にする補完(軽・電撃/軽・火炎/中・火炎) ----
    spark_needle: {
      name: 'SPARK NEEDLE', label: 'SPKN', kind: 'bolt', size: 'light', mount: 'arm', price: 3600,
      archetype: 'special', family: 'electric', fxTier: 2,
      dmgMin: 8, dmgMax: 11, interval: 0.7, heat: 12, range: 70, boltSpeed: 56, chain: 0.4, chainRange: 11,
      color: 0x9fc8ff, colorE: 0xcf9fff, sfx: 'arc', recoil: 0.03, spreadAim: 0.1, tag: '軽・精密電撃連鎖',
    },
    ion_coil: {
      name: 'ION COIL', label: 'IONC', kind: 'tempest', size: 'light', mount: 'arm', price: 6000,
      archetype: 'special', family: 'electric', fxTier: 3,
      dmgTick: 10, tickInterval: 0.25, burnTime: 2.5, interval: 6, range: 40, chargeTime: 1.0, slowMul: 0.8,
      color: 0x9fd0ff, colorE: 0xcf9fff, sfx: 'tempest', recoil: 0.02, spreadAim: 0.1, tag: '軽・電撃照射(上位)',
    },
    ember_bolt: {
      name: 'EMBER BOLT', label: 'EMBR', kind: 'bolt', size: 'light', mount: 'arm', price: 3400,
      archetype: 'special', family: 'fire', fxTier: 2,
      dmgMin: 9, dmgMax: 13, interval: 0.8, heat: 14, range: 55, boltSpeed: 46, boltScale: 1.0, burn: { time: 2.5, dps: 9 },
      color: 0xff8030, colorE: 0xff5020, sfx: 'pulse', recoil: 0.04, spreadAim: 0.2, tag: '軽・火球(延焼)',
    },
    cinder_stream: {
      name: 'CINDER STREAM', label: 'CNDR', kind: 'flame', size: 'light', mount: 'arm', price: 5600,
      archetype: 'special', family: 'fire', fxTier: 3,
      dmgTick: 6, interval: 0.08, heat: 6, range: 20, coneDeg: 24, burn: { time: 3, dps: 11 },
      color: 0xff8030, colorE: 0xff5020, sfx: 'blazer', tag: '軽・火炎放射(上位)',
    },
    fire_salvo: {
      name: 'FIRE SALVO', label: 'FSLV', kind: 'bolt', size: 'medium', mount: 'shoulder', price: 4400,
      archetype: 'power', family: 'fire', fxTier: 3,
      dmgMin: 24, dmgMax: 32, interval: 1.5, heat: 24, range: 52, boltSpeed: 40, boltScale: 1.3, blast: 3, burn: { time: 3, dps: 13 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'brute', recoil: 0.09, spreadAim: 0.2, tag: '中・火球(爆発+延焼)',
    },
    pyre_thrower: {
      name: 'PYRE THROWER', label: 'PYRE', kind: 'flame', size: 'medium', mount: 'arm', price: 7000,
      archetype: 'power', family: 'fire', fxTier: 4,
      dmgTick: 10, interval: 0.08, heat: 7, range: 24, coneDeg: 28, burn: { time: 3.5, dps: 16 },
      color: 0xff7a30, colorE: 0xff5020, sfx: 'blazer', tag: '中・火炎放射(大)',
    },

    // ============================================================
    // v8 P4: 防具/シールド(kind:'armor', size:'any')。武器スロットを1つ消費する。
    //   発射しない非攻撃装備。armor.type で挙動が分岐(barrier/plating/phase/reactive)。
    //   攻撃と防御のトレードオフ(武器が1つ減る)。§4 の肩代わりは発射武器のみ消費し、防具は別レイヤー。
    // ============================================================
    aegis_barrier: {
  ...
  // v8 P3: 武器による被ダメ肩代わり（瀕死で安い武器が盾化→耐久切れで破壊）
  ARMOR_THRESHOLDS: [0.30, 0.20, 0.10], // HP 割合がこれを切るたびに次の武器が盾化
  WPN_DURA_SCALE: 0.05,    // 耐久 = price × これ
  WPN_DURA_MIN: 40,        // 耐久の下限
  WPN_DURA_CAP_ABS: 300,   // 耐久の絶対上限
  WPN_DURA_BODY_RATIO: 0.5, // 上限 = min(ABS, maxHp × これ)。武器が本体より頑丈にならない
...
/** v8 P4: 武器 w がスロットサイズ slotSize に装備可能か(防具 size:'any' は全スロット可) */
function sizeFits(w, slotSize) { return !!w && (w.size === 'any' || w.size === slotSize); }
...
function sanitizeSave(s) {
  ...
  for (const c of PLAYER_CLASSES) {
    ...
    for (let i = 0; i < hp.length; i++) {
      ...
      if (!sizeFits(CONFIG.WEAPONS[w], hp[i])) continue; // V7.1: サイズ不一致は外す(防具 any は全可)
...
function aiTierLoadout(cls, lv) {
  ...
  const lo = cls.hardpoints.map((size, i) => {
...
/** サイズ表示(ハンガーのタグ用) */
const SIZE_LABEL = { light: '軽', medium: '中', heavy: '重', any: '防具' };
...
function autoEquipDefaults(clsKey) {
  ...
  for (let i = 0; i < hp.length; i++) {
    const w = defaults[i];
    if (!w || !CONFIG.WEAPONS[w] || !sizeFits(CONFIG.WEAPONS[w], hp[i])) continue;
...
/** 武器タグ / 機体説明の翻訳ヘルパー(翻訳が無ければ weapon.tag にフォールバック) */
const wtag = (key) => {
  const t = T(`wtag_${key}`);
  if (t !== `wtag_${key}`) return t; // 翻訳あり
  const w = CONFIG.WEAPONS[key];
  return (w && w.tag) ? w.tag : ''; // v8: 新武器/防具は tag を直接表示
};
...
async function loadWeaponDroneGlbs() {
  try { WEAPON_DRONE_GLBS._default = await loadOneDroneGlb(MODEL_BASE + 'weapon_drone_light.glb'); }
  catch (e) { /* 汎用が無くても可 */ }
  await Promise.all(WEAPON_DRONE_KEYS.map(async (k) => {
    try { const s = await loadOneDroneGlb(MODEL_BASE + 'weapon_drone_' + k + '.glb'); if (s) WEAPON_DRONE_GLBS[k] = s; }
...
function buildGlbWeaponDrone(srcScene, tier, th) {
  const g = new THREE.Group();
  const model = srcScene.clone(true);
  // V9.14: 蛍光発光をやめ「重厚なガンメタル + 金属反射」に統一(発光なし)。
  //   本体=テーマのハル色(暗い金属) / アクセント(旧発光部)=テーマ色を鋼へ寄せた淡い金属。
  const hull = new THREE.Color(th.hull);
  const steel = new THREE.Color(0x8c949e);
  const accent = new THREE.Color(th.glow).lerp(steel, 0.62);  // ネオンを抑えた金属の差し色
  model.traverse((o) => {
    if (!o.isMesh) return;
    o.castShadow = true;
    ...
    const mats = (wasArray ? o.material : [o.material]).map((m) => {
      ...
      if (c.emissive) { c.emissive = new THREE.Color(0x000000); c.emissiveIntensity = 0; }  // 発光オフ
      if (WPN_ENV) { c.envMap = WPN_ENV; c.envMapIntensity = 1.3; }  // 反射で金属感
      c.needsUpdate = true;
      return c;
    });
...
function buildDroneLoadout(rig, slots, worldScale, fallbackMuzzle) {
  ...
  slots.forEach((key, i) => {
    ...
    rig.add(group);
    drones.push({ obj: group, slot: { x: base.x, y: base.y, z: base.z + dz }, slotIndex: i, phase: i * 1.7, muzzle });
    groups.push(group);
    muzzles[i] = muzzle;
  });
...
// ============================================================
// v8 P2: エフェクト強度（軽/標準/派手）と価格連動の派手さ係数
//   - FX_LEVEL: 0=軽 / 1=標準 / 2=派手。既定はモバイル「標準」/ PC「派手」
//   - fxMul(): パーティクル数・規模の一括倍率
//   - wpnFxTier(w): 価格から 1〜5（高価ほど派手）。武器に fxTier があれば優先
// ============================================================
const FX_OPTIONS = [
  { key: 'LOW', label: '軽', mul: 0.5 },
  { key: 'MID', label: '標準', mul: 1.0 },
  { key: 'HIGH', label: '派手', mul: 1.6 },
];
let FX_LEVEL = ('ontouchstart' in window) ? 1 : 2; // モバイル=標準 / PC=派手
try {
  const v = localStorage.getItem('rb_fx_level');
  if (v !== null) FX_LEVEL = Math.max(0, Math.min(2, parseInt(v, 10) || 0));
} catch (e) { /* private mode */ }
function fxMul() { return (FX_OPTIONS[FX_LEVEL] || FX_OPTIONS[1]).mul; }
function wpnFxTier(w) {
  if (!w) return 1;
  if (w.fxTier) return w.fxTier;
  const p = w.price || 0;
  return p < 2000 ? 1 : p < 4000 ? 2 : p < 7000 ? 3 : p < 10000 ? 4 : 5;
}
...
class Robot {
  ...
  constructor(scene, cls, name, gltf = null, isPlayer = false, slots = null) {
    ...
    this.maxHp = cls.hp;
    this._baseMaxHp = cls.hp; // v8 P4: BULWARK の最大HP補正を毎回ここから計算(多重適用を防ぐ)
    ...
    this._scene = scene;          // v8 P4: 防具メッシュの遅延生成に使う
    this.armorDome = null;        // AEGIS BARRIER の前面ドーム(遅延生成)
    this.phaseBubble = null;      // PHASE FIELD の無敵バブル(遅延生成)
    ...
    this.kbX = 0;
    this.kbZ = 0;
    // v8: 延焼 DoT(火炎系武器)。burnT>0 の間、burnDps を継続適用
    this.burnT = 0;
    this.burnDps = 0;
    this.burnAtk = null;
    this.burnTick = 0;
    // v8 P3: 武器耐久（被ダメ肩代わり）。スロットごと
    this.wpnDura = [];      // 現在耐久(スロット別)
    this.wpnDuraMax = [];   // 最大耐久
    this.wpnDead = [];      // true=破壊され発射不可
    this.shieldSlot = -1;   // 現在盾化している武器スロット(-1=なし)
    this.armorStage = 0;    // 何段階の閾値を消化したか(0..3)
    this.dmgAbsorbed = 0;   // 肩代わりで吸収した累計(リザルト表示用)
    this.wpnLost = 0;       // 破壊された武器数(リザルト用)
    // v8 P4: 防具/シールド装備の状態(initArmor で装備内容から構築)
    this.armorReduce = 0;       // BULWARK: 全方位ダメージ軽減率(0..0.6)
    this.armorSpeedMul = 1;     // BULWARK: 速度倍率(トレードオフ)
    this.barrierMax = 0;        // AEGIS: 前面バリアの最大値
    this.barrierHp = 0;         // AEGIS: 現在のバリア残量
    this.barrierFrontDot = -1;  // AEGIS: この dot 以上「前方」なら吸収
    this.barrierRegen = 0;      // AEGIS: 毎秒回復量
    this.barrierRegenDelay = 0; // AEGIS: 被弾後この秒数は回復停止
    this.barrierRegenT = 0;     // AEGIS: 回復停止の残り
    this.barrierAbsorbed = 0;   // AEGIS: 吸収累計(リザルト)
    this.phaseSlot = -1;        // PHASE: 発動スロット(-1=未装備)
    this.phaseDur = 0;          // PHASE: 無敵持続(s)
    this.phaseCdMax = 0;        // PHASE: クールダウン(s)
    this.phaseT = 0;            // PHASE: 残り無敵時間
    this.phaseCd = 0;           // PHASE: 残りクールダウン
    this.reactiveChance = 0;    // REACTIVE: 基本発動率
    this.reactiveLowBonus = 0;  // REACTIVE: 瀕死時の加算発動率
    this.reactiveCut = 1;       // REACTIVE: 発動時の被ダメ倍率(小さいほど強い)
  }

  /** v8: 延焼を付与/更新(時間はリフレッシュ・dps は強い方を採用) */
  applyBurn(time, dps, attacker) {
    if (!this.alive || time <= 0 || dps <= 0) return;
    this.burnT = Math.max(this.burnT, time);
    this.burnDps = Math.max(this.burnDps, dps);
    this.burnAtk = attacker || this.burnAtk;
  }
  ...
  applyLevel(lv) {
    ...
    this._baseMaxHp = this.maxHp; // v8 P4: 装甲補正前のレベル基準HP
  ...
  get effectiveSpeed() {
    ...
    s *= this.armorSpeedMul; // v8 P4: BULWARK PLATING の速度トレードオフ
  ...
  canFireSlot(i) {
    ...
    if (this.wpnDead && this.wpnDead[i]) return false; // v8 P3: 破壊された武器は発射不可
    const w = CONFIG.WEAPONS[this.slots[i]];
    if (!w) return false;
    if (w.kind === 'armor') return false; // v8 P4: 防具スロットは発射しない
  ...
  update(dt, time) {
    ...
    // v8 P4: 防具の時間進行(AEGIS バリア再生 / PHASE 無敵・CD)
    if (this.alive) {
    ...
    if (this.armorDome) {
      ...
      if (on) {
        ...
        this.armorDome.position.y += this.chestY * 0.6;
        this.armorDome.rotation.y = this.torsoYaw - Math.PI / 2; // 半球の開口を前方へ
        const k = this.barrierHp / this.barrierMax;
        this.armorDome.material.opacity = 0.08 + 0.16 * k + 0.04 * Math.sin(time * 6);
      }
    }
    // PHASE バブル: 発動中のみ・全周
    if (this.phaseBubble) {
      const on = this.phaseT > 0 && this.alive;
      this.phaseBubble.visible = on;
      if (on) {
        this.phaseBubble.position.copy(this.position);
        this.phaseBubble.position.y += this.chestY * 0.7;
        const fade = this.phaseT < 0.6 ? this.phaseT / 0.6 : 1; // 終了間際フェード
        this.phaseBubble.material.opacity = (0.22 + 0.12 * Math.sin(time * 11)) * fade;
        this.phaseBubble.scale.setScalar(1 + 0.05 * Math.sin(time * 8));
      }
    }
  ...
  reset(x, z, yaw) {
    ...
    this.grounded = true;
    this.initArmor();      // v8 P4: 装備防具を反映(maxHp 補正は hp 設定前に行う)
    this.hp = this.maxHp;
    this.heat = 0;
    this.overheated = false;
    this.slotCd.fill(0);
    ...
    this.initWeaponDurability(); // v8 P3: 武器耐久を装備内容から初期化
  }

  /** v8 P3: 装備武器の耐久を価格から算出して初期化(上限=本体HPの半分まで) */
  initWeaponDurability() {
    const cap = Math.min(CONFIG.WPN_DURA_CAP_ABS, this.maxHp * CONFIG.WPN_DURA_BODY_RATIO);
    this.wpnDura = []; this.wpnDuraMax = []; this.wpnDead = [];
    for (let i = 0; i < this.slots.length; i++) {
      const w = CONFIG.WEAPONS[this.slots[i]];
      if (!w || w.kind === 'armor') { this.wpnDura[i] = 0; this.wpnDuraMax[i] = 0; this.wpnDead[i] = false; continue; }
      const d = Math.round(clamp((w.price || 0) * CONFIG.WPN_DURA_SCALE, CONFIG.WPN_DURA_MIN, cap));
      this.wpnDuraMax[i] = d; this.wpnDura[i] = d; this.wpnDead[i] = false;
    }
    this.shieldSlot = -1; this.armorStage = 0; this.dmgAbsorbed = 0; this.wpnLost = 0;
    // 前マッチで破壊・非表示にしたドローンを再表示(リマッチ/リスポーン対策)
    if (this.model && this.model.drones) for (const d of this.model.drones) if (d && d.obj) d.obj.visible = true;
  }

  /**
   * v8 P4: 装備中の防具(kind:'armor')を走査して効果を構築。reset で毎回呼ぶ。
  ...
  initArmor() {
    ...
    for (let i = 0; i < this.slots.length; i++) {
      ...
      if (a.type === 'plating') {
        ...
        this.phaseSlot = i; this.phaseDur = a.duration || 3; this.phaseCdMax = a.cd || 18;
      } else if (a.type === 'reactive') {
        this.reactiveChance = Math.max(this.reactiveChance, a.baseChance || 0);
        this.reactiveLowBonus = Math.max(this.reactiveLowBonus, a.lowBonus || 0);
        this.reactiveCut = Math.min(this.reactiveCut, a.cut != null ? a.cut : 1);
      }
    }
    // BULWARK: 最大HP補正(レベル基準から再計算 → 多重適用なし)
    this.maxHp = Math.round((this._baseMaxHp || this.maxHp) * (1 + hpBoost));
    this.barrierHp = this.barrierMax; // 開幕は満タン
    this._syncArmorMeshes();
  }
  ...
  _syncArmorMeshes() {
    ...
    if (this.phaseSlot >= 0 && !this.phaseBubble && this._scene) {
      ...
      this.phaseBubble = new THREE.Mesh(geo, new THREE.MeshBasicMaterial({
        color: 0xc69cff, transparent: true, opacity: 0.3,
        blending: THREE.AdditiveBlending, depthWrite: false, side: THREE.DoubleSide,
      }));
      this.phaseBubble.visible = false;
      this._scene.add(this.phaseBubble);
    }
    if (this.phaseBubble) this.phaseBubble.visible = this.phaseT > 0 && this.alive;
  }
}
...
class BoltPool {
  ...
  fire(shooter, origin, dir, w, color) {
    ...
    b.burn = w.burn || null;            // v8: 火炎系(ファイヤーボール/アロー)の延焼 {time,dps}
    b.fxTier = wpnFxTier(w);            // v8 P2: 価格連動のエフェクト強度(高価ほど派手)
    if (b.burn) b.trailInt = 0.012;     // v8: 火炎弾は濃い炎トレイル(燃え盛る球/火矢)
  ...
  update(dt) {
    ...
    for (const b of this.items) {
      ...
      if (b.trail <= 0) {
        ...
        if (b.burn) {
          // v8: 燃え盛る火球/火矢 — 赤橙の炎を尾を引いて撒き、芯は白熱
          const sc = (b.mesh.scale.x || 0.2) * 7;
          game.particles.spawn(b.prev, 2, { color: rng() < 0.5 ? 0xff5a18 : 0xffa028, speed: 1.6, life: 0.38, gravity: 1.5, scale: 1.3 + sc, upBias: 0.6, boost: 2 });
          game.particles.spawn(b.prev, 1, { color: 0xfff0b0, speed: 0.8, life: 0.22, gravity: 0, scale: 0.9 + sc * 0.6, boost: 2.6 });
          if (rng() < 0.35) game.lights.spawn(b.prev, 0xff6020, 16);
        } else {
      ...
      if (hitTarget) {
        ...
        if (game.shieldBlocks(hitTarget, b.prev)) {
          ...
          // v8 P2: 着弾エフェクトを fxTier（価格）× fxMul（強度設定）でスケール
          const ft = 0.7 + (b.fxTier || 1) * 0.3, fm = fxMul();
          game.particles.spawn(_v1, Math.max(3, Math.round(8 * ft * fm)), { color: 0xffcc66, speed: 8 * ft, life: 0.4, gravity: -10, scale: 1.1 * ft, boost: 1.7 });
          game.rings.spawn(_v1, { mode: 'billboard', scale: 2.2 * ft, life: 0.25, color: 0xffd9a0, boost: 1.7 });
          game.lights.spawn(_v1, b.color, 22 * ft);
          ...
          if (b.burn) {
            hitTarget.applyBurn(b.burn.time, b.burn.dps, b.shooter);
            game.particles.spawn(_v1, 5, { color: 0xff7a30, speed: 3, life: 0.5, gravity: -4, scale: 1.1, boost: 1.8 });
          }
        }
        done = true;
      }
  ...
  apply(type, pos, rb) {
    ...
    switch (type.key) {
      case 'REPAIR':
        ...
        game.checkArmorEngage(rb); // v8 P3: 回復で閾値超過なら武器装甲を解除
  ...
  update(dt, time) {
    ...
    if (canShoot) {
      for (let i = 0; i < bot.slots.length; i++) {
        const w = CONFIG.WEAPONS[bot.slots[i]];
        if (!w) continue;
        if (bot.wpnDead && bot.wpnDead[i]) continue; // v8 P3: 破壊された武器は発射不可
        ...
        } else if (w.kind === 'flame') { // v8: 火炎放射(近距離でコーン照射)
          if (dist < (w.range || 20) && bot.canFireSlot(i)) {
            this.game.fireFlame(bot, i);
            this.game.sound.playAt(w.sfx, bot.position, 12);
          }
...
class Game {
  ...
  updateRemoteRobots(dt) {
    ...
    for (const r of this.robots) {
      ...
      if (this.net.role === 'guest') {
        ...
        this.applyNetWeaponState(r, t.wd, t.ss, t.sd); // v8 P3: 武器装甲(破壊/盾化)
        if (t.alive === false && r.alive) { r.alive = false; r.deathT = 0; this.netDeathFx(r); }
      }
    }
  }

  /** v7 M2b/v8 P2: リモート機体撃破の演出(ホストの onKO と同じ特大爆発) */
  netDeathFx(robot) {
    robot.chest(_v1);
    const pos = _v1.clone();
    this.bigMechExplosion(pos, robot.cls ? robot.cls.scale : 1);
    try { this.sound.playAt('explosion', robot.position, 22); } catch (e) {}
  }
  ...
  netTick(dt) {
    ...
    if (this.net.role === 'guest') {
      ...
      for (const r of this.robots) {
        ...
        // v8 P3: 武器装甲もホスト権威で全機分上書き（破壊ビットマスク / 盾スロット / 盾耐久）
        let wd = 0;
        if (r.wpnDead) for (let i = 0; i < r.wpnDead.length; i++) if (r.wpnDead[i]) wd |= (1 << i);
        e.wd = wd;
        e.ss = r.shieldSlot;
        e.sd = (r.shieldSlot >= 0 && r.wpnDura) ? Math.round(r.wpnDura[r.shieldSlot] || 0) : 0;
        snap[r.netId] = e;
      }
  ...
  // ============================================================
  //  v8: 延焼 DoT(火炎系)+ 火炎放射(コーン照射)
  // ============================================================
  /** 延焼の継続ダメージ。権威側(単独/ホスト)のみ HP を削る。ゲストは炎演出のみ */
  updateBurns(dt) {
    const guest = this.net && this.net.role === 'guest';
    for (const r of this.robots) {
      if (r.burnT <= 0) continue;
      r.burnT -= dt;
      this._burnFx(r, dt);
      if (!guest && r.alive) {
        r.burnTick -= dt;
        if (r.burnTick <= 0) {
          r.burnTick = 0.3;
          this.dealDamage(r, Math.max(1, Math.round(r.burnDps * 0.3)), r.position, r.burnAtk);
        }
      }
      if (r.burnT <= 0) { r.burnDps = 0; r.burnAtk = null; r.burnTick = 0; }
    }
  }
  _burnFx(r, dt) {
    if (rng() < dt * 16) {
      r.chest(_v1);
      _v1.x += (rng() - 0.5) * 0.9; _v1.z += (rng() - 0.5) * 0.9; _v1.y -= 0.3;
      this.particles.spawn(_v1, 1, { color: 0xff7a30, speed: 1.2, life: 0.45, gravity: 6, scale: 0.95, upBias: 1, boost: 1.7 });
    }
  }

  /** 火炎放射(flame kind): 前方コーン内の敵へ tick ダメージ + 延焼 + 炎ストリーム。
   *  ループ内 dealDamage がグローバル一時ベクトルを汚すため、銃口/照準はローカル数値に退避。 */
  fireFlame(shooter, slotIdx) {
    const w = CONFIG.WEAPONS[shooter.slots[slotIdx]];
    if (!w) return;
    shooter.registerSlotShot(slotIdx);
    shooter.model.getMuzzleWorld(slotIdx, _muzzle);
    const mx = _muzzle.x, my = _muzzle.y, mz = _muzzle.z;          // 銃口(ローカル退避)
    const ax = Math.sin(shooter.torsoYaw), az = Math.cos(shooter.torsoYaw); // 照準前方
    const range = w.range || 20;
    const cosHalf = Math.cos((w.coneDeg || 24) * Math.PI / 180);
    for (const c of this.robots) {
      if (c === shooter || !c.alive) continue;
      c.chest(_v2);
      const dx = _v2.x - mx, dz = _v2.z - mz;
      const d = Math.hypot(dx, dz);
      if (d < 1e-3 || d > range) continue;
      if ((dx / d) * ax + (dz / d) * az < cosHalf) continue;       // コーン外
      if (this.shieldBlocks(c, shooter.position)) { this.shieldRipple(c, shooter.position); continue; }
      this.dealDamage(c, w.dmgTick || 4, shooter.position, shooter);
      if (w.burn) c.applyBurn(w.burn.time, w.burn.dps, shooter);
    }
    // ---- 炎の柱（前方へ噴き上がる大量の炎ストリーム）----
    const fxTier = w.fxTier || 2;
    const m = fxMul();
    const COLS = [0xfff0a0, 0xffd040, 0xffa028, 0xff5a18, 0xe83010]; // 芯=黄白 → 縁=赤
    const n = Math.max(6, Math.round((9 + fxTier * 3) * m));
    for (let k = 0; k < n; k++) {
      const t = 1 + rng() * range * 0.95;                       // 銃口〜射程端まで
      const spread = 0.5 + t * 0.10;                            // 進むほど扇状に拡散
      _v1.set(
        mx + ax * t + (rng() - 0.5) * 2 * spread,
        my + (rng() - 0.5) * 1.0 + (rng()) * 0.6,               // やや上に立ち上る
        mz + az * t + (rng() - 0.5) * 2 * spread,
      );
      const col = COLS[Math.min(COLS.length - 1, Math.floor((t / range) * COLS.length + rng()))];
      this.particles.spawn(_v1, 1, {
        color: col, speed: 5, life: 0.32 + rng() * 0.22, gravity: -5, upBias: 0.7,
        scale: (2.0 + fxTier * 0.35) * (0.8 + t / range), boost: 2.2,
      });
    }
    // 銃口の白熱コア + 噴射の強い光
    _v1.set(mx + ax * 1.2, my, mz + az * 1.2);
    this.particles.spawn(_v1, Math.max(2, Math.round(3 * m)), { color: 0xfff0c0, speed: 3, life: 0.16, gravity: 0, scale: 2.2 + fxTier * 0.3, boost: 3 });
    this.lights.spawn(_v1, 0xff7a30, 26 + fxTier * 6);
    // 黒煙（炎柱の縁から立ち上る）
    if (rng() < 0.5 * m) {
      _v1.set(mx + ax * (range * 0.5), my + 1, mz + az * (range * 0.5));
      this.particles.spawn(_v1, 1, { color: 0x2a2622, speed: 1.5, life: 0.9, gravity: 4, scale: 2.2, upBias: 1, blending: 'normal' });
    }
  }
  ...
  applyLoadoutHUD() {
    ...
    this.player.slots.forEach((key, i) => {
      ...
      const isArmor = !!(w && w.kind === 'armor'); // v8 P4: 防具スロットは 🛡 表示
      const segLabel = w ? (isArmor ? `🛡${w.label}` : w.label) : '—';
      btn.innerHTML = `<span class="seg-label">${segLabel}</span>`
      ...
      btn.classList.toggle('armor-slot', isArmor);
      this.ui.segs.push({
        seg: btn,
  ...
  dealDamage(target, dmg, sourcePos, attacker = null) {
    ...
    // v8 P4: 防具/シールド装備による軽減(肩代わり P3 より前段の防御レイヤー)
    dmg = this.applyArmorMitigation(target, dmg, sourcePos);
    if (dmg <= 0) {
      if (attacker && attacker !== target) { target.lastAttacker = attacker; target.lastAttackT = this.elapsed; }
      return false; // 防具が全弾を無効化/吸収 → HP 不変・撃破なし
    }
    // v8 P3: この被弾で HP が次の閾値を下回るなら、先に最も安い武器を盾化(大ダメージでも肩代わり)
    if (target.wpnDura && target.shieldSlot < 0 && target.armorStage < CONFIG.ARMOR_THRESHOLDS.length) {
      const wouldRatio = (target.hp - dmg) / target.maxHp;
      if (wouldRatio <= CONFIG.ARMOR_THRESHOLDS[target.armorStage]) this.engageArmor(target);
    }
    // v8 P3: 武器装甲（盾化中の武器が被ダメを肩代わり。HP は保持される）
    if (target.shieldSlot >= 0 && target.wpnDura && !target.wpnDead[target.shieldSlot]) {
      dmg = this.absorbWithWeapon(target, dmg);
      if (dmg <= 0) {
        if (attacker && attacker !== target) { target.lastAttacker = attacker; target.lastAttackT = this.elapsed; }
        return false; // 全弾を武器が吸収 → HP 不変・撃破なし
      }
    }
    ...
    else this.checkArmorEngage(target); // v8 P3: 閾値を切ったら武器を盾化
    return died;
  }
  ...
  shootBolt(shooter, aimPoint, slotIdx) {
    ...
    // マズルフラッシュ(V7.3: DEVASTATOR は衝撃波リング + 強い光)。v8 P2: fxTier でスケール
    const ft = 0.7 + wpnFxTier(w) * 0.3, fm = fxMul();
    this.particles.spawn(_muzzle, Math.max(2, Math.round((pellets > 1 ? 3 : 4) * ft * fm)), { color, speed: 2.5, life: 0.12, gravity: 0, scale: 1.6 * ft, upBias: 0, boost: 2.2 });
    if (w.tracer) {
      this.rings.spawn(_muzzle, { mode: 'billboard', scale: 3.4 * ft, life: 0.3, color, boost: 2 });
      this.lights.spawn(_muzzle, color, 36 * ft);
    } else {
      this.lights.spawn(_muzzle, color, 10 * ft);
    }
  }
  ...
  tryPlayerFireSlot(i) {
    ...
    if (!w || !p.alive) return;
    if (p.wpnDead && p.wpnDead[i]) return; // v8 P3: 破壊された武器は発射不可
    // v8 P4: 防具スロット — PHASE FIELD はそのスロット専用ボタン/キーでのみ発動。
    //   全体 FIRE ボタン(fireAll)の巻き込みでは出さない(無敵の発動タイミングは手動管理)
    if (w.kind === 'armor') {
      if (w.armor && w.armor.type === 'phase' && p.phaseSlot === i && this.input) {
        const explicit = this.input.segHeld[i]
          || !!this.input.keys[InputManager.FIRE_KEYS[i]]
          || !!this.input.keys[`Digit${i + 1}`];
        if (explicit) this.activatePhase(p);
      }
      return;
    }
    ...
    if (w.kind === 'bolt') { // V7.0: エネルギーボルト(実体弾)
      ...
      // v8: 火炎放射(押している間コーン照射 + 延焼)。interval/heat で連続発火を律速
      if (!p.canFireSlot(i)) return;
      this.fireFlame(p, i);
      this.sound.play(w.sfx);
    } else if (w.kind === 'missile') {
  ...
  /**
   * v8 P2: 機体撃破の特大爆発（デブリ飛散＋二重衝撃波＋多段火球＋黒煙）。
   *   sizeK で規模スケール（重量級ほど大）。FX_LEVEL で粒子量を増減（性能ガード）。
   *   onKO（権威側）と netDeathFx（ゲスト側）の両方から呼ぶ＝全員で同じ大爆発。
   */
  bigMechExplosion(pos, sizeK = 1) {
    const m = fxMul();
    const S = Math.max(1, sizeK);
    const N = (c) => Math.max(1, Math.round(c * m));
    const gy = getGroundHeight(pos.x, pos.z);
    // 第1段: 大火球 + 白フラッシュ + 二重衝撃波（地面＋空中）+ 強光 + シェイク
    this.particles.spawn(pos, N(34 * S), { color: 0xffb050, speed: 15 * S, life: 1.0, gravity: -6, scale: 2.6 * S, boost: 1.9 });
    this.particles.spawn(pos, N(16 * S), { color: 0xff4422, speed: 10 * S, life: 1.25, gravity: -4, scale: 3.4 * S, boost: 1.5 });
    this.particles.spawn(pos, N(8), { color: 0xffffff, speed: 6, life: 0.25, gravity: 0, scale: 3.6 * S, boost: 3 });
    this.rings.spawn(pos, { mode: 'ground', scale: 11 * S, life: 0.55, color: 0xffd089, boost: 2, y: gy + 0.3 });
    this.rings.spawn(pos, { mode: 'billboard', scale: 8 * S, life: 0.4, color: 0xfff0d0, boost: 2.2 });
    this.lights.spawn(pos, 0xff6622, 80 * S);
    this.shakeFrom(pos, 0.7 * S, 50);
    // デブリ（金属片が放射状に飛散→重力で落下）。暗い金属色＋通常合成で「破片」感
    const deb = N(Math.round(11 * S));
    for (let i = 0; i < deb; i++) {
      _v2.copy(pos); _v2.y += 0.6;
      this.particles.spawn(_v2, 1, {
        color: i % 3 ? 0x4c4c54 : 0x26262c, speed: 9 * S + rng() * 7, life: 1.1 + rng() * 0.7,
        gravity: 9, scale: 0.7 + rng() * 0.8, upBias: 0.9, boost: 1.15, blending: 'normal',
      });
    }
    // 第2段(+0.18s): 二次火球 + 追加の地面衝撃波
    this.fxQueue.push({ t: this.elapsed + 0.18, fn: () => {
      this.particles.spawn(pos, N(14 * S), { color: 0xffc060, speed: 11 * S, life: 0.7, gravity: -4, scale: 2.2 * S, boost: 2.3 });
      this.rings.spawn(pos, { mode: 'ground', scale: 14 * S, life: 0.5, color: 0xffbb66, boost: 1.8, y: gy + 0.3 });
      this.lights.spawn(pos, 0xffaa44, 55 * S);
    } });
    // 第3段(+0.4s): 黒煙の立ち上り + 余韻フラッシュ
    this.fxQueue.push({ t: this.elapsed + 0.4, fn: () => {
      this.particles.spawn(pos, N(14), { color: 0x222226, speed: 4, life: 1.9, gravity: 3.5, scale: 3 * S, upBias: 1.2, blending: 'normal' });
      this.rings.spawn(pos, { mode: 'billboard', scale: 13 * S, life: 0.5, color: 0xfff0d0, boost: 2 });
      this.lights.spawn(pos, 0xffeecc, 70 * S);
    } });
  }

  /** v8 P2: 武器破壊の爆発（P3 の肩代わりで耐久 0 → 呼び出し予定）。tier で規模スケール */
  weaponBreakFx(pos, tier = 2) {
    const m = fxMul();
    const s = 0.8 + tier * 0.18;
    this.particles.spawn(pos, Math.max(2, Math.round(10 * s * m)), { color: 0xffb060, speed: 8 * s, life: 0.6, gravity: -3, scale: 1.4 * s, boost: 2 });
    this.particles.spawn(pos, Math.max(2, Math.round(6 * s * m)), { color: 0x5a5a62, speed: 6 * s, life: 0.8, gravity: 8, scale: 0.6 * s, upBias: 0.6, boost: 1.1, blending: 'normal' });
    this.rings.spawn(pos, { mode: 'billboard', scale: 3.2 * s, life: 0.32, color: 0xffd9a0, boost: 1.9 });
    this.lights.spawn(pos, 0xff8030, 30 * s);
    try { this.sound.playAt('explosion', pos, 14); } catch (e) {}
  }

  // ============================================================
  //  v8 P4: 防具/シールド装備(kind:'armor')の被ダメ処理
  //   PHASE(無敵) → REACTIVE(確率カット+反射) → BULWARK(全方位軽減) → AEGIS(前面バリア吸収)
  //   の順に適用し、残ダメージ(>=0)を返す。dealDamage(権威側)から呼ばれる。
  // ============================================================
  applyArmorMitigation(target, dmg, sourcePos) {
    ...
    // REACTIVE GUARD: 被弾時に確率で大幅カット(瀕死ほど発動率UP)+反射スパーク
    if (target.reactiveChance > 0) {
      const lowK = 1 - clamp(target.hp / target.maxHp, 0, 1);
      if (rng() < target.reactiveChance + target.reactiveLowBonus * lowK) {
        dmg *= target.reactiveCut;
    ...
    if (target.barrierMax > 0 && target.barrierHp > 0) {
      ...
      target.barrierRegenT = target.barrierRegenDelay; // 被弾で再生を一旦停止
      dmg -= absorbed;
  ...
  _barrierFaces(target, fromPos) {
    if (!fromPos) return false;
    const dx = fromPos.x - target.position.x, dz = fromPos.z - target.position.z;
    const d = Math.hypot(dx, dz);
    if (d < 1e-3) return false;
    const dot = (dx * Math.sin(target.torsoYaw) + dz * Math.cos(target.torsoYaw)) / d;
    return dot >= target.barrierFrontDot;
  }

  /** AEGIS バリア被弾の波紋(前面・青)。破壊時はより大きく */
  barrierHitFx(target, fromPos, broke) {
    const m = fxMul();
    target.chest(_v5);
    if (fromPos) { _v4.subVectors(fromPos, _v5).normalize(); _v5.addScaledVector(_v4, 2.2); }
    this.rings.spawn(_v5, { mode: 'billboard', scale: broke ? 4.4 : 2.6, life: 0.34, color: 0x88e0ff, boost: 1.9 });
    this.particles.spawn(_v5, Math.max(1, Math.round((broke ? 8 : 3) * m)), { color: 0x88e0ff, speed: broke ? 8 : 3, life: 0.3, gravity: 0, scale: 1.1, boost: 1.9 });
    if (broke) this.lights.spawn(_v5, 0x66ccff, 30);
    try { this.sound.playAt('shieldHit', _v5, 13); } catch (e) {}
  }

  /** REACTIVE GUARD 発動の反射スパーク(金) */
  reactiveFx(target, fromPos) {
    const m = fxMul();
    target.chest(_v5);
    this.rings.spawn(_v5, { mode: 'billboard', scale: 3.0, life: 0.28, color: 0xffd070, boost: 2 });
    this.particles.spawn(_v5, Math.max(2, Math.round(7 * m)), { color: 0xffc050, speed: 9, life: 0.32, gravity: 2, scale: 1.0, boost: 2.2 });
    this.lights.spawn(_v5, 0xffb040, 22);
    if (target.model && target.model.flash) target.model.flash(0xffd070, 0.16);
    try { this.sound.playAt('shieldHit', target.position, 11); } catch (e) {}
  }
  ...
  phaseHitFx(target) {
    const m = fxMul();
    target.chest(_v5);
    this.rings.spawn(_v5, { mode: 'billboard', scale: 3.2, life: 0.26, color: 0xc69cff, boost: 1.8 });
    this.particles.spawn(_v5, Math.max(1, Math.round(3 * m)), { color: 0xc69cff, speed: 4, life: 0.25, gravity: 0, scale: 1.0, boost: 1.8 });
  }

  /** PHASE FIELD 発動(成功で true)。発射ボタン押下/AI の瀕死判定から呼ばれる */
  activatePhase(robot) {
    if (!robot || robot.phaseSlot < 0 || !robot.alive) return false;
    if (robot.phaseCd > 0 || robot.phaseT > 0) return false;
    robot.phaseT = robot.phaseDur;
    robot.phaseCd = robot.phaseCdMax;
    if (robot.phaseBubble) robot.phaseBubble.visible = true;
    robot.chest(_v5);
    this.rings.spawn(_v5, { mode: 'billboard', scale: 5, life: 0.5, color: 0xc69cff, boost: 2.2 });
    this.lights.spawn(_v5, 0xb070ff, 40);
    try { this.sound.playAt('shieldHit', robot.position, 16); } catch (e) {}
    if (robot === this.player) { this.sound.play('lock', 0.9); this.showArmorAnnounce('PHASE FIELD ◆ 無敵', true); }
    return true;
  }

  /** v8 P4: AI の防具運用 — PHASE FIELD を瀕死(<35%HP)かつ CD 明けで自動発動 */
  updateArmorAI() {
    if (this.net && this.net.role === 'guest') return; // 権威側(単独/ホスト)のみ
    for (const e of this.enemies) {
      if (!e.alive || e.phaseSlot < 0) continue;
      if (e.phaseCd <= 0 && e.phaseT <= 0 && e.hp / e.maxHp < 0.35) this.activatePhase(e);
    }
  }

  // ============================================================
  //  v8 P3: 武器による被ダメ肩代わり（瀕死で安い武器が盾化→耐久切れで破壊）
  //   権威側(単独/ホスト)の dealDamage から呼ばれる。プレイヤーも AI も同じ仕組み。
  // ============================================================
  /** 生存中(非破壊・耐久あり)の最も安い武器スロット。無ければ -1 */
  cheapestAliveWeapon(robot) {
    let best = -1, bestPrice = Infinity;
    for (let i = 0; i < robot.slots.length; i++) {
      if (robot.wpnDead[i] || (robot.wpnDuraMax[i] || 0) <= 0) continue;
      const w = CONFIG.WEAPONS[robot.slots[i]];
      if (!w) continue;
      if ((w.price || 0) < bestPrice) { bestPrice = w.price || 0; best = i; }
    }
    return best;
  }

  /** 盾化中の武器で被ダメを肩代わり。耐久を超えた分だけ残ダメを返す(通常 0) */
  absorbWithWeapon(robot, dmg) {
    const s = robot.shieldSlot;
    const absorbed = Math.min(dmg, robot.wpnDura[s]);
    robot.wpnDura[s] -= absorbed;
    robot.dmgAbsorbed += absorbed;
    if (robot.model && robot.model.flash) robot.model.flash(0x66ccff, 0.18); // 帯電フラッシュ(青)
    if (robot.wpnDura[s] <= 0) { this.destroyWeapon(robot, s); robot.shieldSlot = -1; }
    return dmg - absorbed;
  }

  /** 最も安い生存武器を盾化(段階を1つ消化)。武器が無ければ false */
  engageArmor(robot) {
    robot.armorStage++;
    const s = this.cheapestAliveWeapon(robot);
    if (s < 0) return false;
    robot.shieldSlot = s;
    this.weaponShieldUpFx(robot, s);
    if (robot === this.player) {
  ...
  /** HP が閾値(30/20/10%)を切るたび最も安い武器を盾化。回復で閾値超過なら盾解除 */
  checkArmorEngage(robot) {
    if (!robot.alive) return;
    const thr = CONFIG.ARMOR_THRESHOLDS;
    const ratio = robot.hp / robot.maxHp;
    if (ratio > thr[0]) { robot.shieldSlot = -1; robot.armorStage = 0; return; } // 回復で解除
    if (robot.shieldSlot >= 0) return;
    while (robot.armorStage < thr.length && ratio <= thr[robot.armorStage]) {
      if (this.engageArmor(robot)) break;  // 1 段階盾化(以後 HP 保持)。武器無しなら段階だけ進む
    }
  }

  /** 武器破壊(発射不可化 + 爆発 + ドローン非表示 + 通知) */
  destroyWeapon(robot, slot) {
    if (robot.wpnDead[slot]) return;
    robot.wpnDead[slot] = true;
    robot.wpnDura[slot] = 0;
    robot.wpnLost++;
    robot.model.getMuzzleWorld(slot, _muzzle);
    this.weaponBreakFx(_muzzle.clone(), wpnFxTier(CONFIG.WEAPONS[robot.slots[slot]]));
    this.hideWeaponDrone(robot, slot);
    console.info('[P3] 武器破壊', robot === this.player ? 'PLAYER' : 'AI', 'slot', slot);
    if (robot === this.player) {
      const w = CONFIG.WEAPONS[robot.slots[slot]];
      try { showToast(`💥 ${w ? w.label : '武器'} が破壊された`); } catch (e) {}
    }
  }

  /** 盾化開始の演出(青い帯電フラッシュ + リング + 光) */
  weaponShieldUpFx(robot, slot) {
    if (robot.model && robot.model.flash) robot.model.flash(0x66ccff, 0.45);
    robot.chest(_v5);
    this.rings.spawn(_v5, { mode: 'billboard', scale: 3.4, life: 0.4, color: 0x66ccff, boost: 2 });
    this.lights.spawn(_v5, 0x66ccff, 32);
  }

  /** 破壊された武器ドローン(見た目)を隠す。drones はスロット index を slotIndex に保持 */
  hideWeaponDrone(robot, slot) {
    try {
      const ds = robot.model && robot.model.drones;
      if (!ds) return;
      for (const d of ds) {
        if (d && d.slotIndex === slot && d.obj) { d.obj.visible = false; return; }
      }
    } catch (e) { /* 構造差は無視(発射不可・HUD で十分伝わる) */ }
  }

  /** v8 P3: 武器装甲 HUD（盾化中の武器名＋耐久バー）+ 破壊スロットの淡色化 */
  updateWeaponArmorHUD() {
    const p = this.player;
    let el = document.getElementById('wpn-armor-hud');
    const active = p && p.alive && p.shieldSlot >= 0 && !this.gameOver;
    if (!active) {
      ...
      if (!el) {
        el = document.createElement('div');
        el.id = 'wpn-armor-hud';
        el.style.cssText = 'position:fixed;top:54px;left:50%;transform:translateX(-50%);z-index:39;'
          + 'font-family:Orbitron,sans-serif;text-align:center;color:#bfe8ff;pointer-events:none;text-shadow:0 2px 6px #000;';
        document.body.appendChild(el);
      }
      const s = p.shieldSlot, w = CONFIG.WEAPONS[p.slots[s]];
      const pct = p.wpnDuraMax[s] ? Math.max(0, p.wpnDura[s] / p.wpnDuraMax[s]) : 0;
      el.innerHTML = `<div style="font-size:13px;font-weight:800;letter-spacing:1px">🛡 武器装甲: <b style="color:#66ccff">${w ? w.label : '—'}</b></div>`
        + `<div style="margin:3px auto 0;width:150px;height:7px;border-radius:4px;background:rgba(0,0,0,.5);border:1px solid #66ccff">`
        + `<div style="width:${(pct * 100).toFixed(0)}%;height:100%;border-radius:4px;background:#66ccff"></div></div>`;
      el.style.display = 'block';
    }
    // 破壊された武器スロットのボタンを淡色化
    if (p && p.wpnDead && this.ui && this.ui.segs) {
      for (let i = 0; i < this.ui.segs.length; i++) {
        const seg = this.ui.segs[i];
        if (seg && seg.seg) seg.seg.style.opacity = p.wpnDead[i] ? '0.3' : '';
      }
    }
  }
  hideWeaponArmorHUD() { const el = document.getElementById('wpn-armor-hud'); if (el) el.style.display = 'none'; }

  /** v8 P4: 防具 HUD(AEGIS バリア残量 / PHASE FIELD の発動可否・CD)。装備時のみ表示 */
  updateArmorEquipHUD() {
    const p = this.player;
    let el = document.getElementById('armor-equip-hud');
    const hasBarrier = p && p.barrierMax > 0;
    const hasPhase = p && p.phaseSlot >= 0;
    const active = p && p.alive && !this.gameOver && (hasBarrier || hasPhase);
    if (!active) { if (el) el.style.display = 'none'; return; }
    if (!el) {
      el = document.createElement('div');
      el.id = 'armor-equip-hud';
      el.style.cssText = 'position:fixed;left:12px;bottom:96px;z-index:38;pointer-events:none;'
        + 'font-family:Orbitron,sans-serif;color:#cfe8ff;text-shadow:0 2px 6px #000;font-size:11px;font-weight:800;';
      document.body.appendChild(el);
    }
    let html = '';
    if (hasBarrier) {
    ...
    if (hasPhase) {
      let label, color;
      if (p.phaseT > 0) { label = `◆ PHASE 無敵 ${p.phaseT.toFixed(1)}s`; color = '#d8b4ff'; }
      else if (p.phaseCd > 0) { label = `◆ PHASE 充填 ${Math.ceil(p.phaseCd)}s`; color = '#8a7aa0'; }
      else { label = '◆ PHASE 発動可 (発射ボタン)'; color = '#c69cff'; }
      html += `<div style="color:${color}">${label}</div>`;
    }
    el.innerHTML = html;
    el.style.display = 'block';
  }
  ...
  applyNetWeaponState(robot, wd, ss, sd) {
    if (typeof wd === 'number' && robot.wpnDead) {
      for (let i = 0; i < robot.slots.length; i++) {
        const dead = !!(wd & (1 << i));
        if (dead && !robot.wpnDead[i]) {       // 新たに破壊された → 破壊演出 + ドローン非表示
          robot.wpnDead[i] = true;
          try { robot.model.getMuzzleWorld(i, _muzzle); this.weaponBreakFx(_muzzle.clone(), 2); } catch (e) {}
          this.hideWeaponDrone(robot, i);
        } else { robot.wpnDead[i] = dead; }
      }
    }
    if (typeof ss === 'number') robot.shieldSlot = ss;
    if (ss >= 0 && robot.wpnDura) robot.wpnDura[ss] = sd || 0;
  }
  ...
  repairOnKill(bot) {
    ...
    this.checkArmorEngage(bot); // v8 P3: 回復で閾値超過なら武器装甲を解除
    return amount;
  }
  ...
  showResult() {
    ...
    this.ui.overlayStats.textContent =
      ...
      // v8 P3: 武器装甲の戦績(肩代わりで耐えたダメージ / 失った武器)
      + ((this.player && (this.player.dmgAbsorbed > 0 || this.player.wpnLost > 0))
        ? ` ・ 🛡 装甲肩代わり ${Math.round(this.player.dmgAbsorbed)} ・ 喪失武器 ${this.player.wpnLost}`
        : '');
  ...
  redeploy(setup) {
    for (const r of this.robots) {
      ...
      if (r.armorDome) this.scene.remove(r.armorDome);   // v8 P4
      if (r.phaseBubble) this.scene.remove(r.phaseBubble); // v8 P4
    }
    this.setup = setup;
  ...
  updateHUD(dt) {
    ...
    for (let i = 0; i < ui.segs.length; i++) {
      ...
      if (w.kind === 'armor') { // v8 P4: 防具スロット(PHASE は CD 扇形 / 他は常時 ready)
        let af = 0;
        if (w.armor && w.armor.type === 'phase' && player.phaseSlot === i) {
          af = player.phaseCdMax > 0 ? player.phaseCd / player.phaseCdMax : 0;
          seg.classList.toggle('ready', player.phaseCd <= 0 && player.phaseT <= 0);
          seg.classList.toggle('charging', player.phaseT > 0);
        } else {
          seg.classList.add('ready'); seg.classList.remove('charging');
        }
        seg.classList.remove('overheat', 'nolock');
        cdEl.style.setProperty('--cd', Math.min(1, af).toFixed(3));
        continue;
      }
  ...
  loop() {
    ...
    // v8 P4: 防具(AI の PHASE 自動発動 / プレイヤーの防具 HUD)
    if (!this.gameOver) this.updateArmorAI();
    this.updateArmorEquipHUD();
...
function updateDock(dt, t) {
  if (!DOCK.built) return;
  // V9.17: ドラッグ中は手動回転(ポインタ側で回す)。離した後は慣性で回り、
  //   止まったらゆっくり自動回転に復帰。
  if (DOCK.dragging) {
    // 手動中は何もしない(onMove で rotation.y を直接更新)
  } else if (Math.abs(DOCK.spinVel) > 0.0006) {
    DOCK.turntable.rotation.y += DOCK.spinVel;
    DOCK.spinVel *= 0.94;                 // 慣性減衰
  } else {
    DOCK.turntable.rotation.y += dt * 0.25; // ゆっくり自動回転
  }
...
function thumbHTML(key, cssClass) {
  if (THUMBS[key]) return `<img class="${cssClass}" src="${THUMBS[key]}" alt="">`;
  const w = CONFIG.WEAPONS[key];
  const fb = (w && w.kind === 'armor') ? '🛡' : '🔫'; // v8 P4: 防具は盾アイコン
  return `<span class="${cssClass} thumb-fb">${fb}</span>`;
}
...
function showWeaponInfo(key, sticky) {
  ...
  // v8 P4: 防具は DPS でなく防御効果を表示
  if (w.kind === 'armor' && w.armor) {
    const a = w.armor;
    const ar = [['種別', '防具・シールド']];
    if (a.type === 'barrier') {
      ar.push(['タイプ', '前面シールド(再生式)']);
      ar.push(['バリア量', `${a.hp}`]);
      ar.push(['防御範囲', `前方 ±${a.frontDeg || 70}°`]);
      ar.push(['再生', `${a.regen}/s(被弾後 ${a.regenDelay}s 停止)`]);
    } else if (a.type === 'plating') {
      ar.push(['タイプ', '重装甲(常時)']);
      ar.push(['最大HP', `+${Math.round((a.hpBoost || 0) * 100)}%`]);
      ar.push(['被ダメ軽減', `${Math.round((a.reduce || 0) * 100)}%(全方位)`]);
      ar.push(['速度', `×${(a.speedMul || 1).toFixed(2)}`]);
    } else if (a.type === 'phase') {
      ar.push(['タイプ', '時限バブル(発射ボタンで発動)']);
      ar.push(['無敵時間', `${a.duration}s`]);
      ar.push(['クールダウン', `${a.cd}s`]);
      ar.push(['効果', '発動中 360° 完全無敵']);
    } else if (a.type === 'reactive') {
      ar.push(['タイプ', '反応装甲(被弾時)']);
      ar.push(['発動率', `${Math.round((a.baseChance || 0) * 100)}%(瀕死で+${Math.round((a.lowBonus || 0) * 100)}%)`]);
      ar.push(['発動時被ダメ', `×${(a.cut != null ? a.cut : 1).toFixed(2)}`]);
    }
    ar.push([T('wiMount'), w.mount === 'arm' ? 'ARM' : 'SHOULDER']);
    ar.push(['装備', '武器スロット 1 つを使用']);
    ar.push([T('wiPrice'), `${fmtPt(w.price)} pt`]);
    $id('wpn-info-body').innerHTML = ar
...
// v8: 武器の種別(ファミリー)判定。新武器は w.family を持つ。旧武器は kind/archetype から推定。
function weaponFamily(w) {
  if (!w) return 'special';
  if (w.family) return w.family;
  if (w.kind === 'flame' || w.burn) return 'fire';
  if (w.chain || w.kind === 'tempest') return 'electric';
  if (w.archetype === 'rapid') return 'rapid';
  if (w.archetype === 'range') return 'sniper';
  if (w.archetype === 'power') return 'cannon';
  return 'special';
}
// v8: ショップ種別タブ(全/連射/電撃/火炎/砲撃/狙撃/特殊)
const WEAPON_FAMILY_TABS = [
  ['all', '全'], ['rapid', '連射'], ['electric', '電撃'], ['fire', '火炎'],
  ['cannon', '砲撃'], ['sniper', '狙撃'], ['special', '特殊'], ['armor', '防具'],
];
...
function renderWeaponModal() {
  ...
  // v8: 種別(ファミリー)タブ。武器が増えたので種別で絞り込めるように
  const fam = HANGAR.weaponFamilyFilter || 'all';
  const tabBar = document.createElement('div');
  tabBar.className = 'wl-fam-tabs';
  tabBar.style.cssText = 'display:flex;flex-wrap:wrap;gap:6px;margin:0 0 8px;';
  for (const [fk, flabel] of WEAPON_FAMILY_TABS) {
    const b = document.createElement('button');
    b.type = 'button';
    b.textContent = flabel;
    b.className = 'wl-fam-tab' + (fk === fam ? ' on' : '');
    b.style.cssText = 'padding:5px 11px;border-radius:8px;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;'
      + (fk === fam
        ? 'background:linear-gradient(180deg,#8ef6ff,#3ec8e0);border:1px solid #8ef6ff;color:#06121a;'
        : 'background:rgba(110,243,255,.08);border:1px solid rgba(110,243,255,.4);color:#9fe8ff;');
    b.addEventListener('click', () => { HANGAR.weaponFamilyFilter = fk; uiSfx(); renderWeaponModal(); });
    tabBar.appendChild(b);
  }
  list.appendChild(tabBar);

  const famMatch = (w) => fam === 'all' || weaponFamily(w) === fam;
  ...
  groups.push(['armor', '防具']); // v8 P4: 防具(size:'any'・全スロット可)は専用グループで表示
  for (const [size, label] of groups) {
    const isArmorGroup = size === 'armor';
    // 防具グループは常に表示(showAllSizes に依存しない)。サイズ群は装備可能サイズのみ既定表示
    if (!isArmorGroup && size !== slotSize && !HANGAR.showAllSizes) continue;
    // この種別フィルタでこのグループに該当武器が無ければグループごと省略
    const anyInGroup = Object.values(CONFIG.WEAPONS).some((w) =>
      (isArmorGroup ? w.kind === 'armor' : (w.size === size && w.kind !== 'armor')) && famMatch(w));
    if (!anyInGroup) continue;
    // グループ見出し
    const head = document.createElement('div');
    head.className = `wl-group sz-head-${isArmorGroup ? 'any' : size}`;
    head.innerHTML = isArmorGroup
      ? `<span class="sl-size sz-any">防具</span>防具・シールド(全スロット装備可)`
      : `<span class="sl-size sz-${size}">${SIZE_LABEL[size]}</span>${label}`;
    list.appendChild(head);

    for (const [key, w] of Object.entries(CONFIG.WEAPONS)) {
      if (isArmorGroup ? (w.kind !== 'armor') : (w.size !== size || w.kind === 'armor')) continue;
      if (!famMatch(w)) continue; // v8: 種別フィルタ
      const matches = isArmorGroup ? true : (size === slotSize); // このスロットに装備できるか(防具は全可)
  ...
  const otherCount = Object.values(CONFIG.WEAPONS).filter((w) => w.size !== slotSize && w.kind !== 'armor').length;
  if (otherCount > 0) {
...
// v8 P2: エフェクト強度の切替(軽/標準/派手)。即時反映(spawn 時に fxMul を参照)
function setFxLevel(level, persist = true) {
  FX_LEVEL = Math.max(0, Math.min(FX_OPTIONS.length - 1, level));
  if (persist) { try { localStorage.setItem('rb_fx_level', String(FX_LEVEL)); } catch (e) {} }
  refreshFxBtn();
}
function refreshFxBtn() {
  const btn = document.getElementById('fx-btn');
  if (btn) btn.textContent = '✨ ' + (FX_OPTIONS[FX_LEVEL] || FX_OPTIONS[1]).label;
}
...
/** 現在プレイ中のゲームの本番(GitHub Pages)URL を path から判定 */
function liveUrlForThisGame() {
  const base = 'https://sohei-t.github.io/ai-agent-portfolio/robo-battle-3d/';
  const p = location.pathname;
  const seg = /\/v8(\/|$)/.test(p) ? 'v8/' : /\/v7(\/|$)/.test(p) ? 'v7/' : '';
  return base + seg;
}

/** 公開完了ポップアップ（URL 表示 + 開く + コピー） */
function showDeployPopup(url) {
  let ov = document.getElementById('deploy-popup');
  if (ov) ov.remove();
  ov = document.createElement('div');
  ov.id = 'deploy-popup';
  ov.style.cssText = 'position:fixed;inset:0;z-index:200;display:flex;align-items:center;justify-content:center;'
    + 'background:rgba(4,8,14,.72);font-family:Orbitron,sans-serif;';
  ov.innerHTML = `
    <div style="background:#0d1620;border:1px solid #3fd9d4;border-radius:14px;max-width:440px;width:90%;padding:22px;text-align:center;box-shadow:0 0 40px rgba(63,217,212,.3)">
      <div style="font-size:18px;font-weight:800;color:#6ef3ff;letter-spacing:2px">✅ 本番公開 完了</div>
      <div style="font-size:12px;color:#8fb3c8;margin:8px 0 4px">公開URL（GitHub Pages の反映に数分かかる場合があります）</div>
      <div id="dp-url" style="word-break:break-all;background:#04101a;border:1px solid #2a3a48;border-radius:8px;padding:10px;font-family:ui-monospace,monospace;font-size:13px;color:#aef0ff">${url}</div>
      <div style="display:flex;gap:8px;margin-top:14px">
        <a id="dp-open" href="${url}" target="_blank" rel="noopener" style="flex:1;text-decoration:none;padding:11px;border-radius:9px;background:linear-gradient(180deg,#37e0d6,#1b8f99);color:#04121a;font-weight:800">🌐 開く</a>
        <button id="dp-copy" type="button" style="flex:1;padding:11px;border-radius:9px;border:1px solid #3fd9d4;background:rgba(63,217,212,.12);color:#aef0ff;font-family:inherit;font-weight:800;cursor:pointer">📋 コピー</button>
        <button id="dp-close" type="button" style="padding:11px 16px;border-radius:9px;border:1px solid #3a4654;background:#1a242e;color:#cfe;font-family:inherit;font-weight:800;cursor:pointer">閉じる</button>
      </div>
    </div>`;
  document.body.appendChild(ov);
  ov.querySelector('#dp-close').onclick = () => ov.remove();
  ov.addEventListener('click', (e) => { if (e.target === ov) ov.remove(); });
  ov.querySelector('#dp-copy').onclick = async () => {
    try { await navigator.clipboard.writeText(url); ov.querySelector('#dp-copy').textContent = '✅ コピー済'; }
    catch (e) { ov.querySelector('#dp-copy').textContent = '手動でコピーしてください'; }
  };
}
...
async function onDeployClick() {
  ...
  try {
    const r = await fetch('/api/deploy', {
      ...
      body: JSON.stringify({ message: 'deploy: ゲームUIから公開' }),
    });
    const j = await r.json().catch(() => ({}));
    if (j.ok) {
      showToast('✅ 本番公開が完了しました');
      showDeployPopup(liveUrlForThisGame()); // URL をポップアップ表示
    } else {
    ...
    alert('❌ デプロイ API を呼べませんでした: ' + (e && e.message || e)
      + '\n\nゲームを launch_v8.command(devserver.py)で起動していますか？\n'
...
window.RB_onNetData = (peerId, m) => {
  ...
  if (m.t === 'st' && g.net.role === 'host') {
    ...
    for (const k in m.r) {
      ...
      if (id === myId) {
        // 自機: 位置はローカル優先。HP/撃破・武器装甲のみホスト権威で反映
        if (g.player && typeof e.hp === 'number') g.player.hp = e.hp;
        if (g.player) g.applyNetWeaponState(g.player, e.wd, e.ss, e.sd); // v8 P3
        ...
        g._netTargets.set(id, e); // 他機: 位置 + HP/alive + 武器装甲(updateRemoteRobots で適用)
      }
    }
...
(async () => {
  ...
  try {
    ...
    // ---- v8 P2: エフェクト強度切替(✨ 軽/標準/派手) ----
    refreshFxBtn();
    const fxBtn = $id('fx-btn');
    if (fxBtn) fxBtn.addEventListener('click', () => { setFxLevel((FX_LEVEL + 1) % FX_OPTIONS.length); uiSfx(); });
