...
class GitHubIssuePRManager:
    ...
    def _get_github_username(self) -> str:
        ...
        try:
            ...
            pass
        raise RuntimeError("Could not determine GitHub username. Set GITHUB_USERNAME env var or install gh CLI.")
...
"""
        ...
        # ========================================
        # Step 4: PRマージ（Issueは自動クローズ）
        # ========================================
        if pr_number and not dry_run:
            self.print_banner("Step 4: PRマージ", "─")
